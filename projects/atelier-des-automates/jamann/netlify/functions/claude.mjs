...
// Proxy serverless intelligent multi-fournisseur (OpenRouter/Llama3, Gemini, ou Claude).
// Détecte automatiquement les clés d'environnement configurées sur Netlify
...
export default async (req) => {
    ...
    try {
      ...
      const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        ...
        headers: {
          ...
          'HTTP-Referer': 'https://stef-jaman-manoire.netlify.app',
  ...
  return Response.json(
    {
      error: 'Toutes les clés API configurées sur Netlify sont invalides, expirées ou absentes.',
      detail: 'Veuillez vérifier vos clés OPENROUTER_API_KEY, GEMINI_API_KEY ou ANTHROPIC_API_KEY dans vos paramètres Netlify.'
    },
    { status: 502 },
  );
};
